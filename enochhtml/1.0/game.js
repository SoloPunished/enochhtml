...
const sfxCollect1 = new Audio("../Sound/collect_orb_(1).mp3");
const sfxCollect2 = new Audio("../Sound/collect_orb_(2).mp3");
...
function updateCamera() {
  ...
  if (gridLargerThanCanvas && (tileX !== lastCameraTile.x || tileY !== lastCameraTile.y)) {
    sfxCameraShift.pause();
    sfxCameraShift.currentTime = 0;
    sfxCameraShift.volume = 0.25;
    sfxCameraShift.play();
...
function showUpgradeMenu() {
  ...
  queueSound(sfxUpgradeMenu, SOUND_PRIORITY.ui);
